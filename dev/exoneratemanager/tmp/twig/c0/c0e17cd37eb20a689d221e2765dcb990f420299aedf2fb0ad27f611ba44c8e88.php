...
($context["allow_user_drop_database"] ?? null)));
    ...
    {
        return new Twig_Source("", "server/databases/databases_header.twig", "/usr/www/toxic/exoneratepanel/exoneratemanager/templates/server/databases/databases_header.twig");
    }
}
